...
// Mock até resolver o ambiente de testes da TEM SAUDE
...
func (c *Client) RegisterBeneficiary(ctx context.Context, customer *entity.Customer) (string, error) {
	// TODO: REMOVE THIS MOCK WHEN PRODUCTION URL IS AVAILABLE
	fmt.Println("\n===============================================================")
	...
	// Retorna sucesso fake para o fluxo seguir para o RabbitMQ/Email
